...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "subject_name", "school_class", "assigned_by", "assigned_by_name",
            "due_date", "created_at", "max_score", "attachment",
            "is_graded", "submission_count", "is_overdue",
        )
...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "text_content", "submitted_at", "status", "score",
...
class GradeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "teacher", "value", "max_value", "label", "note", "date", "is_final",
        )
