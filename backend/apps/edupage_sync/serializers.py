...
class EdupageSyncLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = EdupageSyncLog
        fields = ("id", "timestamp", "level", "message")


class EdupageSyncJobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "triggered_by", "sync_types", "result_summary",
            "error_message", "logs",
        )
